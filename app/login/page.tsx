      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Connectez-vous pour accéder à vos feeds et paramètres</CardDescription>
          </CardHeader>
          <CardContent>
            <form action={`/auth/login${isExtension ? "?extension=true" : ""}`} method="post" className="space-y-4">
          ...
          <CardFooter className="flex justify-center">
            <p className="text-sm text-gray-600">
              ...
              <Link href={`/signup${isExtension ? "?extension=true" : ""}`} className="text-primary hover:underline">
                S'inscrire
              </Link>
            </p>
          </CardFooter>
