  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <div className="flex flex-1">
        <aside
          className={`fixed inset-y-0 left-0 z-20 mt-16 w-64 transform border-r bg-white transition-transform duration-300 md:translate-x-0 ${
        ...
        >
          <nav className="flex h-full flex-col p-4">
              ...
              {navigation.map((item) => (
                <Link
                  ...
                  className={`flex items-center gap-3 rounded-md px-3 py-2 text-sm font-medium ${
                    pathname === item.href ? "bg-primary-light text-primary" : "text-gray-700 hover:bg-gray-100"
                  }`}
                >
                  {item.icon}
                  {item.name}
            ...
            <div className="mt-auto rounded-lg bg-gradient-to-r from-primary/10 to-secondary/10 p-4">
              <h3 className="mb-2 text-sm font-medium">Extension Chrome</h3>
